...
batches = [
    "112-2_medicine-4_batch-001",
    "112-2_medicine-4_batch-002",
    "112-2_medicine-4_batch-003",
    "112-2_medicine-4_batch-004",
    "112-2_medicine-4_batch-005"
]
...
with open('scratch/112_questions_dump.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(out))
print("Done writing to scratch/112_questions_dump.txt")
