...
def main():
    ...
    updates_dir = Path("scratch/rewrite_updates/109-2_medicine-2")
    ...
    for file_path in updates_dir.glob("*.json"):
        ...
        for item in updates:
            ...
            if qid not in q_map:
                print(f"  Warning: question_id {qid} not found in medicine-2.json. Skipping.")
                continue
            ...
            if item.get("manual_review_notes"):
                # If there are notes, log them or append
